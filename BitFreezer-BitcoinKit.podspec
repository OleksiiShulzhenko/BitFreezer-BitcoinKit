...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of BitFreezer-BitcoinKit.'
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'BitFreezer-BitcoinKit/Classes/**/*'
  
  # s.resource_bundles = {
  #   'BitFreezer-BitcoinKit' => ['BitFreezer-BitcoinKit/Assets/*.png']
  # }
