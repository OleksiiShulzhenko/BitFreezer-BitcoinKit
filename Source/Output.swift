...
public class Output {
    ...
    public func set(publicKeyPath: String?, changeOutput: Bool) {
    ...
    public init(withValue value: Int, index: Int, lockingScript script: Data, transactionHash: Data = Data(), type: ScriptType = .unknown, redeemScript: Data? = nil, address: String? = nil, keyHash: Data? = nil, publicKeyPath: String?, changeOutput: Bool) {
        self.value = value
        self.lockingScript = script
        self.index = index
        self.transactionHash = transactionHash
